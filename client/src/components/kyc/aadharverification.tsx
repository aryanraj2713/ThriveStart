...
export default function AadhaarVerification({
    ...
    return (
        <AadhaarContainer>
            <h2 className="text-lg font-semibold mb-4 bg-none">
                {t("Here are the details we fetched from your Aadhaar card:")}
            </h2>
            <AadhaarDetails className="bg-none">
                <Field>
                    <Label>UID:</Label>
            ...
            <Button className="my-10 bg-gray-800 hover:bg-gray-900 text-white" onClick={onSubmit}>
                {t("Verify & Continue")}
            </Button>
        </AadhaarContainer >
    );
