...
import AadhaarVerification from "@/components/kyc/aadharverification";
    ...
    return (
        <div className="max-w-[1300px] mx-auto sm:p-10 py-10 px-5 min-h-screen">
            ...
            <div className="flex justify-center">
                <button
                    className="mt-4 bg-gray-800 hover:bg-gray-900 text-white flex justify-center font-bold py-2 px-4 rounded"
                    onClick={startVoice}
                >
                    Start Voice
                </button>
