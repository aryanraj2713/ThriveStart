...
const UpdateCompanyForm: React.FC = () => {
    const [company, setCompany] = useState({
        ...
        companyState: '',
        yearlyRevenue: 0,
        monthlyRevenue: new Array<any>(12).fill(0),
        monthlySales: new Array<any>(12).fill(0),
        grossMargin: 0,
        netMargin: 0,
        ebidta: 0,
        cashBurn: 0,
    ...
    const handleMonthlyRevenueChange = (e: React.ChangeEvent<HTMLInputElement>, index: any) => {
    ...
    const handleMonthlySalesChange = (e: React.ChangeEvent<HTMLInputElement>, index: any) => {
                ...
                <div className="py-10 min-h-screen">
                    ...
                    <div className="container">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="ownersName">
                                    Owner's Name
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="companyState">
                                    Company State
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="yearlyRevenue">
                                    Yearly Revenue
                                </label>
                                <input
                                    type="text"
                            ...
                            {/* Monthly Revenue */}
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2">Monthly Revenue</label>
                            ...
                            {/* Monthly Sales */}
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2">Monthly Sales</label>
                                {company.monthlySales.map((sales, index) => (
                                    <input
                                        key={index}
                                        type="text"
                                        placeholder={`Month ${index + 1}`}
                                        className="shadow appearance-none border  bg-transparent rounded w-full py-2 px-3 text-gray-700 leading-tight focus
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="grossMargin">
                                    Gross Margin
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="netMargin">
                                    Net Margin
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="ebidta">
                                    EBITDA
                                </label>
                                <input
                                    type="text"
                                    id="ebidta"
                                    name="ebidta"
                                    className="shadow appearance-none border r bg-transparent ounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="cashBurn">
                                    Cash Burn
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="hasUSP">
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="isBootstrapped">
                                    Is Bootstrapped
                                </label>
                                <input
                                    type="checkbox"
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="debt">
                                    Debt
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="govtAID">
